...
values 
 (1, N'tg://resolve?domain=FaberlicChat_bot&start=%code%') --telegram
,(3, N'viber://pa?chatURI=prototypefl&context=%code%') --viber
,(4, N'https://vk.com/write-179649792?ref=%code%&ref_source=webchat') --VK
