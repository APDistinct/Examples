...
DROP view [Msg].[MessageStatsRowsView]
GO
...
select 
  ...
  , case when mtu.[ToTransportTypeId] = 100 then 1 else 0 end as [CantSendToWebChat]
...
from [Msg].[Message] m
left join [Msg].[MessageToUser] mtu on m.[Id] = mtu.[MsgId] and mtu.[ToTransportTypeId] = /**WebChat**/100
