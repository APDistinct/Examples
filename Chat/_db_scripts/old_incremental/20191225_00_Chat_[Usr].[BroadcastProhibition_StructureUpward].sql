...
/****** Object:  UserDefinedFunction [Usr].[BroadcastProhibition_Structure]    Script Date: 25.12.2019 18:21:33 ******/
DROP FUNCTION IF EXISTS [Usr].[BroadcastProhibition_StructureUpward]
GO
