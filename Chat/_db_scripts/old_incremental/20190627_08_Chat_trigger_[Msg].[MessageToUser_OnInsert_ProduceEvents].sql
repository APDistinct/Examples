...
/****** Object:  Trigger [MessageToUser_OnInsert_ProduceEvents]    Script Date: 27.06.2019 19:58:18 ******/
DROP TRIGGER IF EXISTS [Msg].[MessageToUser_OnInsert_ProduceEvents]
GO

/****** Object:  Trigger [Msg].[MessageToUser_OnInsert_ProduceEvents]    Script Date: 27.06.2019 19:58:18 ******/
SET ANSI_NULLS ON
GO
