...
CREATE DATABASE [FLChat] /*
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'FLChat', FILENAME = N'FLChat.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'FLChat_log', FILENAME = N'FLChat_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
*/
GO
