...
{
    [TestClass()]
    public class Usr_ImportUsersSalesForce : SqlDatabaseTestClass
    {

        public Usr_ImportUsersSalesForce() {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void LastImportDate() {
            SqlDatabaseTestActions testActions = this.LastImportDateData;
            // Execute the pre-test script
            // 
            System.Diagnostics.Trace.WriteLineIf((testActions.PretestAction != null), "Executing pre-test script...");
            SqlExecutionResult[] pretestResults = TestService.Execute(this.PrivilegedContext, this.PrivilegedContext, testActions.PretestAction);
        ...
        private void InitializeComponent() {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Usr_ImportUsersSalesForce));
            ...
            Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction LastImportDate_TestAction;
            ...
            this.LastImportDateData = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestActions();
            ...
            LastImportDate_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            ...
            Owner_Ins_MissedOwner_Value.ExpectedValue = "-1a";
            ...
            Phone_Ins_FLUserNumber.ExpectedValue = "-3a";
            ...
            Phone_Upd_FLUserNumber.ExpectedValue = "-2a";
            ...
            Mail_Ins_FLUserNumber.ExpectedValue = "-3a";
            ...
            Mail_Upd_FLUserNumber.ExpectedValue = "-2a";
            ...
            // 
            // LastImportDate_TestAction
            // 
            LastImportDate_TestAction.Conditions.Add(scalarValueCondition1);
            LastImportDate_TestAction.Conditions.Add(scalarValueCondition2);
            resources.ApplyResources(LastImportDate_TestAction, "LastImportDate_TestAction");
            // 
            ...
            // LastImportDateData
            // 
            this.LastImportDateData.PosttestAction = null;
            this.LastImportDateData.PretestAction = null;
            this.LastImportDateData.TestAction = LastImportDate_TestAction;
        }
        ...
        private SqlDatabaseTestActions LastImportDateData;
    }
}
